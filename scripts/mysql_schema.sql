...
CREATE INDEX idx_guesthouses_manager ON guesthouses(manager_id);
CREATE INDEX idx_rooms_guesthouse ON rooms(guesthouse_id);
CREATE INDEX idx_availability_room_date ON room_availability(room_id, date);
CREATE INDEX idx_photos_guesthouse ON photos(guesthouse_id);
